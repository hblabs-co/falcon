...
enum Strings {
    ...
    private static let table: [AppLanguage: [StringKey: String]] = [
        .english: [
            ...
            .aboutBuild: "Build",
            .aboutGdprNote: "Both embedding and match scoring are performed by Mistral AI, an EU-based provider headquartered in France and operating under the GDPR. By using Falcon you consent to your CV data being processed by Mistral AI for these purposes. The pipeline also supports local inference via Ollama for fully self-hosted deployments.",
            ...
            .profileCVFormats: "Word (.docx) or PDF (.pdf)",
        ...
        .german: [
            ...
            .profileCVFormats: "Word (.docx) oder PDF (.pdf)",
        ...
        .spanish: [
            ...
            .aboutGdprNote: "Tanto el embedding como el cálculo de coincidencia son realizados por Mistral AI, un proveedor de la UE con sede en Francia que opera bajo el RGPD. Al usar Falcon aceptas que tus datos del CV sean procesados por Mistral AI con estos fines. El pipeline también admite inferencia local vía Ollama para despliegues totalmente auto-hospedados.",
            ...
            .profileCVFormats: "Word (.docx) o PDF (.pdf)",
            .profileCVEmailLabel: "Email",
