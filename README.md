...
|         |                         |             |                                                                                                                                                                                                              |
|         |                         |             |                                                                                                                                                                                                              |
| `LOCAL` | **falcon-admin**        | 8082        | Backoffice gateway. Single bearer-gated HTTP service consumed exclusively by falcon-nest. Issues 30-day test magic links, exposes user / session / device / match / config / realtime-activity views, serves CV downloads (presigned). |
