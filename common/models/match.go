...
type MatchResultEvent struct {
	...
	PositivePoints  []string `json:"positive_points"  bson:"positive_points"`
	NegativePoints  []string `json:"negative_points"  bson:"negative_points"`
	ImprovementTips []string `json:"improvement_tips" bson:"improvement_tips"`
	...
	// Summary is a single short German sentence generated by the LLM, used as
	// the iOS push notification body in falcon-signal.
	// Example: "Score 7.8 · React/TypeScript stark, fehlendes AWS und Docker."
